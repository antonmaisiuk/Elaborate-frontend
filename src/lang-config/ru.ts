  ...
  ru: {
    translation: {
      ...
      settings: {
        ...
        weakPass: 'Новый пароль слишком слабый',
        ...
        tooltip: `Пароль должен состоять из:
                <ul>
                  <li>8 знаков</li>
                  <li>1 буквы верхнего и нижнего регистра</li>
                  <li>1 цифра</li>
                  <li>1 спец. символ</li>
                </ul>`,
      },
      invests: {
        totalStocks: 'Сумма акций',
        totalCrypto: 'Сумма криптовалют',
        totalMetals: 'Сумма металов',
      ...
      'totalTrans': 'Сумма транзакций',
      'recentTrans': 'Недавние транзакции',
      'recentCrypto': 'Недавние криптовалюты',
      'recentStocks': 'Недавние акции',
      'recentMetals': 'Недавние металлы',
      'recentOther': 'Недавние остальные инвестиции',
      'transactions': 'Транзакции',
      'basic': 'Основные инвестции',
      'other': 'Остальные инвестции',
      'investments': 'Инвестции',
      'stocks': 'Акции',
      'crypto': 'Криптовалюты',
      'metals': 'Металлы',
